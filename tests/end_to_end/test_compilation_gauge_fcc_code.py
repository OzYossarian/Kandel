...
class GaugeFloquetColourCodePermuted(GaugeColourTicTacToeCode):
...
def test_e_anyon_memory_experiment():
    ...
    Syndrome extractor: CxCyCzExtractor
    ...
    code = GaugeFloquetColourCode(4,2)
    ...
    expected_circuit = """QUBIT_COORDS(0, 2) 0
QUBIT_COORDS(0, 6) 1
QUBIT_COORDS(0, 10) 2
QUBIT_COORDS(1, 1) 3
QUBIT_COORDS(1, 3) 4
...
TICK
CZ 4 10 7 11 12 9 19 24 22 26 28 25 34 40 37 41 42 39 49 54 52 56 58 55
TICK
CZ 4 0 58 1 7 2 12 15 19 16 22 17 28 31 34 30 37 32 42 45 49 46 52 47
TICK
...
TICK
CX 3 9 6 11 13 10 18 24 21 25 29 26 33 39 36 41 43 40 48 54 51 55 59 56
TICK
CX 3 0 6 1 59 2 13 16 18 15 21 17 29 32 33 30 36 31 43 46 48 45 51 47
TICK
MX 3 6 13 18 21 29 33 36 43 48 51 59
DETECTOR(4, 2, 0) rec[-10] rec[-9] rec[-12]
DETECTOR(10, 8, 0) rec[-8] rec[-7] rec[-5]
DETECTOR(16, 2, 0) rec[-6] rec[-4] rec[-3]
DETECTOR(22, 8, 0) rec[-11] rec[-2] rec[-1]
SHIFT_COORDS(0, 0, 1)
TICK
PAULI_CHANNEL_1(0.1, 0, 0) 0 1 2 9 10 11 15 16 17 24 25 26 30 31 32 39 40 41 45 46 47 54 55 56
TICK
...
RX 5 8 14 20 23 27 35 38 44 50 53 57
TICK
CZ 5 10 8 9 14 11 20 25 23 26 27 24 35 40 38 39 44 41 50 55 53 56 57 54
TICK
CZ 57 0 5 1 8 2 14 17 23 15 20 16 27 30 35 31 38 32 44 47 53 45 50 46
TICK
MX 5 8 14 20 23 27 35 38 44 50 53 57
SHIFT_COORDS(0, 0, 1)
TICK
...
RX 4 7 12 19 22 28 34 37 42 49 52 58
TICK
CX 4 10 7 11 12 9 19 24 22 26 28 25 34 40 37 41 42 39 49 54 52 56 58 55
TICK
CX 4 0 58 1 7 2 12 15 19 16 22 17 28 31 34 30 37 32 42 45 49 46 52 47
TICK
MX 4 7 12 19 22 28 34 37 42 49 52 58
DETECTOR(4, 10, 0) rec[-92] rec[-95] rec[-94] rec[-10] rec[-8] rec[-11]
DETECTOR(10, 4, 0) rec[-90] rec[-93] rec[-91] rec[-9] rec[-7] rec[-6]
DETECTOR(16, 10, 0) rec[-86] rec[-89] rec[-88] rec[-5] rec[-4] rec[-2]
DETECTOR(22, 4, 0) rec[-96] rec[-87] rec[-85] rec[-12] rec[-3] rec[-1]
SHIFT_COORDS(0, 0, 1)
TICK
PAULI_CHANNEL_1(0.1, 0, 0) 0 1 2 9 10 11 15 16 17 24 25 26 30 31 32 39 40 41 45 46 47 54 55 56
TICK
...
TICK
MX 3 6 13 18 21 29 33 36 43 48 51 59
DETECTOR(4, 2, 0) rec[-93] rec[-96] rec[-94] rec[-10] rec[-9] rec[-12]
DETECTOR(10, 8, 0) rec[-89] rec[-92] rec[-91] rec[-8] rec[-7] rec[-5]
DETECTOR(16, 2, 0) rec[-87] rec[-90] rec[-88] rec[-6] rec[-4] rec[-3]
DETECTOR(22, 8, 0) rec[-95] rec[-86] rec[-85] rec[-11] rec[-2] rec[-1]
SHIFT_COORDS(0, 0, 1)
TICK
PAULI_CHANNEL_1(0.1, 0, 0) 0 1 2 9 10 11 15 16 17 24 25 26 30 31 32 39 40 41 45 46 47 54 55 56
TICK
...
TICK
MX 5 8 14 20 23 27 35 38 44 50 53 57
DETECTOR(4, 6, 0) rec[-92] rec[-95] rec[-94] rec[-10] rec[-9] rec[-12]
DETECTOR(10, 0, 0) rec[-90] rec[-93] rec[-91] rec[-8] rec[-7] rec[-5]
DETECTOR(16, 6, 0) rec[-86] rec[-89] rec[-88] rec[-6] rec[-4] rec[-3]
DETECTOR(22, 0, 0) rec[-96] rec[-87] rec[-85] rec[-11] rec[-2] rec[-1]
SHIFT_COORDS(0, 0, 1)
TICK
PAULI_CHANNEL_1(0.1, 0, 0) 0 1 2 9 10 11 15 16 17 24 25 26 30 31 32 39 40 41 45 46 47 54 55 56
TICK
...
TICK
MX 3 6 13 18 21 29 33 36 43 48 51 59
OBSERVABLE_INCLUDE(0) rec[-12] rec[-9] rec[-6] rec[-3]
DETECTOR(1, 1, 0) rec[-24] rec[-12]
DETECTOR(1, 7, 0) rec[-23] rec[-11]
DETECTOR(4, 4, 0) rec[-22] rec[-10]
DETECTOR(7, 1, 0) rec[-21] rec[-9]
...
OBSERVABLE_INCLUDE(0) rec[-20] rec[-17] rec[-8] rec[-5]
DETECTOR(4, 2, 0) rec[-57] rec[-60] rec[-58] rec[-24] rec[-21] rec[-20] rec[-18] rec[-17] rec[-15]
DETECTOR(4, 6, 0) rec[-104] rec[-107] rec[-106] rec[-23] rec[-20] rec[-19] rec[-17] rec[-16] rec[-14]
DETECTOR(10, 0, 0) rec[-102] rec[-105] rec[-103] rec[-18] rec[-15] rec[-13] rec[-12] rec[-10] rec[-9]
DETECTOR(10, 8, 0) rec[-53] rec[-56] rec[-55] rec[-16] rec[-14] rec[-13] rec[-11] rec[-10] rec[-7]
DETECTOR(16, 2, 0) rec[-51] rec[-54] rec[-52] rec[-12] rec[-9] rec[-8] rec[-6] rec[-5] rec[-3]
DETECTOR(16, 6, 0) rec[-98] rec[-101] rec[-100] rec[-11] rec[-8] rec[-7] rec[-5] rec[-4] rec[-2]
DETECTOR(22, 0, 0) rec[-108] rec[-99] rec[-97] rec[-24] rec[-22] rec[-21] rec[-6] rec[-3] rec[-1]
DETECTOR(22, 8, 0) rec[-59] rec[-50] rec[-49] rec[-23] rec[-22] rec[-19] rec[-4] rec[-2] rec[-1]"""
    assert str(stim_circuit) == expected_circuit
...
def test_m_anyon_memory_experiment():
    ...
    Initial States: all |0>
    Final measurements: all Z
    Observables: horizontal and vertical m anyon observables
    """
    # I don't call this an X or Z memory experiment, because the observables are not X or Z strings.
    # I refer to them by the Z2 anyon that's being pushed around the torus (magnetic charge here).
    code = GaugeFloquetColourCodePermuted(4, 2)
    compiler = AncillaPerCheckCompiler(noise_model=CodeCapacityBitFlipNoise(0.1), syndrome_extractor=CxCyCzExtractor())
    data_qubits = code.data_qubits.values()
    ...
    stim_circuit: stim.Circuit = compiler.compile_to_stim(code,
                                                          layers=2, 
                                                          initial_stabilizers=initial_stabilizers,
                                                          final_measurements= final_measurements,
                                                          logical_observables=logical_observables)
...
TICK
MX 5 8 14 20 23 27 35 38 44 50 53 57
DETECTOR(4, 6, 0) rec[-10] rec[-9] rec[-12]
DETECTOR(10, 0, 0) rec[-8] rec[-7] rec[-5]
DETECTOR(16, 6, 0) rec[-6] rec[-4] rec[-3]
DETECTOR(22, 0, 0) rec[-11] rec[-2] rec[-1]
SHIFT_COORDS(0, 0, 1)
TICK
PAULI_CHANNEL_1(0.1, 0, 0) 0 1 2 9 10 11 15 16 17 24 25 26 30 31 32 39 40 41 45 46 47 54 55 56
TICK
...
OBSERVABLE_INCLUDE(0) rec[-18] rec[-17] rec[-14] rec[-13]
DETECTOR(4, 6, 0) rec[-56] rec[-59] rec[-58] rec[-23] rec[-20] rec[-19] rec[-17] rec[-16] rec[-14]
DETECTOR(10, 0, 0) rec[-54] rec[-57] rec[-55] rec[-18] rec[-15] rec[-13] rec[-12] rec[-10] rec[-9]
DETECTOR(4, 10, 0) rec[-104] rec[-107] rec[-106] rec[-22] rec[-21] rec[-19] rec[-18] rec[-16] rec[-13]
DETECTOR(10, 4, 0) rec[-102] rec[-105] rec[-103] rec[-17] rec[-15] rec[-14] rec[-12] rec[-11] rec[-8]
DETECTOR(16, 6, 0) rec[-50] rec[-53] rec[-52] rec[-11] rec[-8] rec[-7] rec[-5] rec[-4] rec[-2]
DETECTOR(22, 0, 0) rec[-60] rec[-51] rec[-49] rec[-24] rec[-22] rec[-21] rec[-6] rec[-3] rec[-1]
DETECTOR(22, 4, 0) rec[-108] rec[-99] rec[-97] rec[-24] rec[-23] rec[-20] rec[-5] rec[-3] rec[-2]
DETECTOR(16, 10, 0) rec[-98] rec[-101] rec[-100] rec[-10] rec[-9] rec[-7] rec[-6] rec[-4] rec[-1]"""
