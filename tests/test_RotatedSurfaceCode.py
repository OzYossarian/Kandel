...
def test_init_boundary_checks():
    ...
    # TODO discuss CNOT order on boundary
    # add an optional ghost operator (Identity gate) that is useful for compiling...
#    boundary_ancillas, checks = d5_sc.init_boundary_checks(d5_sc.data_qubits, 5)
