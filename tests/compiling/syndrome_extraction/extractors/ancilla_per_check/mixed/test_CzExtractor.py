...
def test_cz_extractor_on_XYZ_check():
    ...
    expected = {
        ...
        4: {
            data_qubits[0]: [MockInstruction([data_qubits[0], ancilla], 'CZ')],
            ancilla: [MockInstruction([data_qubits[0], ancilla], 'CZ')]},
        6: {
            data_qubits[0]: [MockInstruction([data_qubits[0]], 'H')]},
        # Extract Y check
        8: {
        ...
        10: {
            data_qubits[1]: [MockInstruction([data_qubits[1], ancilla], 'CZ')],
            ancilla: [MockInstruction([data_qubits[1], ancilla], 'CZ')]},
        12: {
            data_qubits[1]: [MockInstruction([data_qubits[1]], 'H_YZ')]},
        # Extract Z check
        14: {
            data_qubits[2]: [MockInstruction([data_qubits[2], ancilla], 'CZ')],
            ancilla: [MockInstruction([data_qubits[2], ancilla], 'CZ')]},
        # Measure ancilla
        16: {
